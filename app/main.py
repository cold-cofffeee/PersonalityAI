...
async def serve_frontend():
    ...
    try:
        frontend_path = TEMPLATES_DIR / "frontend.html"
...
async def serve_admin():
    ...
    try:
        admin_path = TEMPLATES_DIR / "admin_panel.html"
...
async def cache_stats():
    ...
    # Get LRU cache stats
    lru_stats = cache_manager.get_cache_stats()
...
async def serve_admin_panel():
    ...
    """
    return FileResponse(TEMPLATES_DIR / "admin_panel.html")
